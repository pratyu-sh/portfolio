  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 mt-5 p-5 md:p-16 md:w-[60vw] border-zinc-700 bg-[linear-gradient(180deg,#27272a,#18181b)] " style={{background:'rgba(4,7,29,1)'}}
            key={idx}
          >
            <blockquote>
              <div
